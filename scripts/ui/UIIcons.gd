...
const _PATHS := {
	...
	# M22 Phase 2.5 — the only two icons genuinely missing against the v0.3
	# design's resource-icon list (gold, rum, wood, iron, research,
	# cannonball); generated by tools/ui_kit/gen_kit.py, not sourced/moved
	# from anywhere (design.md §5a — "claude design outputs/" turned out to
